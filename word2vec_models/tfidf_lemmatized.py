...
model_path = os.path.join(base_dir, "word2vec_lemmatized_skipgram_w10_d300.model")
output_path = os.path.join(base_dir, "tfidf_filtered_lemmatized.csv")
...
print(f"✅ Lemmatized için TF-IDF dosyası kaydedildi: {output_path}")
