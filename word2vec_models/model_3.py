...
# === Kaydet ===
model_name = f"word2vec_lemmatized_cbow_w{window}_d{vector_size}.model"
model_path = os.path.join(current_dir, model_name)
model.save(model_path)

# === TF-IDF benzeri CSV çıktısı ===
vector_out_path = os.path.join(current_dir, f"vectors_lemmatized_cbow_w{window}_d{vector_size}.csv")
vectors = []
words = []
